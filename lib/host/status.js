 ...
 */
import { DEFAULT_CLINE_KEY_REFS, PLUGIN_VERSION, resolveCredentialsFilePath } from './defaults.js'
import { maskKey } from './ids.js'
...
export function buildStatus(deps, options) {
  const { config, pool, diag, quotaStore, clineMatch } = deps
