    ...
    resetStats() {
      ...
      for (const entry of entries.values()) {
        ...
        for (const model of Object.keys(entry.stats.byModel)) {
          byModel[model] = { sent: 0, ok: 0, limited: 0, lastUsedAt: 0, tokens: { input: 0, output: 0, total: 0, cached: 0 } }
        }
        entry.stats = { sent: 0, ok: 0, limited: 0, lastModel: '', byModel, tokens: { input: 0, output: 0, total: 0, cached: 0 } }
        entry.lastUsedAt = 0
