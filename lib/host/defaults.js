...
export const PLUGIN_VERSION = '2.9.9'
...
export const DEFAULT_CLINE_KEY_REFS = Array.from({ length: 11 }, (_, i) => `CLINE_API_KEY_${i + 2}`)
...
export const MONITORED_UPSTREAM_MODELS = ['cline-free/deepseek-v4.1-flash', 'z-ai/glm-5.3-flash', 'cline-free/kimi-k3']
...
export const PREFERRED_UPSTREAM = {
  ...
  'cline-free/kimi-k3': 'openai-compatible-private',
}
